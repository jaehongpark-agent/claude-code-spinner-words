# Claude Code 스피너 단어 커스터마이징

`settings.json`의 `spinnerVerbs` 설정으로 Claude Code의 스피너 단어를 교체하거나 추가할 수 있습니다.
...
이 저장소에는 Claude Code에서 추출한 192개 스피너 단어와 한국어 번역이 포함되어 있습니다.
